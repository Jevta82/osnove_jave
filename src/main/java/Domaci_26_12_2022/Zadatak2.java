...
public class Zadatak2 {
    public static void main(String[] args) {
        //Napisati metodu koja vrsi spajanje
        // punog imena i vraca tu vrednost. Metoda od parametara prima ime i prezime
    ...
    public static void imePrezime (String ime, String prezime) {
